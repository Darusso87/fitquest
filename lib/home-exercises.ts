...
export const HOME_EXERCISE_CATALOG: HomeExercise[] = [
  // LOWER BODY - BEGINNER
  {
    ...
    difficulty: 'beginner',
    targetMuscles: ['quads', 'glutes', 'hamstrings'],
    tags: ['lower_body', 'compound'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 12, defaultRest: '60s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/squat.svg',
      instructions: [
        'Place phone at hip height, 6-8 feet away',
        'Stand sideways to camera',
        'Ensure full body visible from head to feet'
      ]
    },
    demoMediaPath: 'https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=400&h=300&fit=crop',
    alternatives: ['squat_chair', 'squat_wall'],
    avoidWhen: []
  },
  {
    id: 'squat_chair',
    ...
    difficulty: 'beginner',
    targetMuscles: ['quads', 'glutes'],
    tags: ['lower_body', 'low_impact', 'avoid_knees'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 10, defaultRest: '60s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/chair-squat.svg',
      instructions: [
        'Place chair behind you',
        'Phone at hip height, side view',
        'Lightly touch chair, then stand'
      ]
    },
    demoMediaPath: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=400&h=300&fit=crop',
    alternatives: ['squat_bodyweight'],
    avoidWhen: []
  },
  ...
  // LOWER BODY - INTERMEDIATE
  {
    ...
    difficulty: 'intermediate',
    targetMuscles: ['quads', 'glutes', 'hamstrings'],
    tags: ['lower_body', 'unilateral'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 10, defaultRest: '60s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/lunge.svg',
      instructions: [
        'Side view, phone at waist height',
        'Step forward into lunge',
        'Count total reps (both legs)'
      ]
    },
    demoMediaPath: 'https://images.unsplash.com/photo-1611672585731-fa10603fb9e0?w=400&h=300&fit=crop',
    alternatives: ['lunge_reverse', 'squat_bodyweight'],
    avoidWhen: []
  },
  {
    id: 'lunge_reverse',
    ...
    difficulty: 'intermediate',
    targetMuscles: ['quads', 'glutes'],
    tags: ['lower_body', 'unilateral', 'avoid_knees'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 10, defaultRest: '60s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/lunge.svg',
      instructions: [
        ...
        'Easier on knees than forward'
      ]
    },
    demoMediaPath: 'https://images.unsplash.com/photo-1598971639058-fab3c3109a00?w=400&h=300&fit=crop',
    alternatives: ['lunge_forward'],
    avoidWhen: []
  },
  ...
  // GLUTES
  {
    ...
    difficulty: 'beginner',
    targetMuscles: ['glutes', 'hamstrings'],
    tags: ['lower_body', 'avoid_knees', 'floor'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 15, defaultRest: '45s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/bridge.svg',
      instructions: [
        'Lie on floor, knees bent',
        'Phone on floor, side view',
        'Lift hips until body forms straight line'
      ]
    },
    demoMediaPath: 'https://images.unsplash.com/photo-1598971639058-fab3c3109a00?w=400&h=300&fit=crop',
    alternatives: ['glute_bridge_single'],
    avoidWhen: ['avoid_back']
  },
  {
    ...
    difficulty: 'intermediate',
    targetMuscles: ['glutes', 'hamstrings', 'core'],
    tags: ['lower_body', 'unilateral', 'floor'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 10, defaultRest: '60s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/bridge-single.svg',
      instructions: [
        'Lie on floor, one leg extended',
        'Side view optimal',
        'Lift hips on one leg'
      ]
    },
    demoMediaPath: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop',
    alternatives: ['glute_bridge'],
    avoidWhen: ['avoid_back']
  },
  ...
  // UPPER BODY - PUSH
  {
    ...
    difficulty: 'intermediate',
    targetMuscles: ['chest', 'triceps', 'shoulders'],
    tags: ['upper_body', 'push', 'floor'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 10, defaultRest: '60s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/pushup.svg',
      instructions: [
        'Side view, phone at chest height',
        'Plank position, hands shoulder-width',
        'Lower chest to floor, push back up'
      ]
    },
    demoMediaPath: 'https://images.unsplash.com/photo-1571019613576-2b22c76fd955?w=400&h=300&fit=crop',
    alternatives: ['pushup_knee', 'pushup_incline'],
    avoidWhen: []
  },
  {
    id: 'pushup_knee',
    ...
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/pushup-knee.svg',
      instructions: [
    ...
    demoMediaPath: 'https://images.unsplash.com/photo-1598971639058-fab3c3109a00?w=400&h=300&fit=crop',
    alternatives: ['pushup_regular', 'pushup_wall'],
    avoidWhen: []
  },
  {
    id: 'pushup_incline',
    ...
    difficulty: 'beginner',
    targetMuscles: ['chest', 'triceps'],
    tags: ['upper_body', 'push'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 12, defaultRest: '60s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/pushup-incline.svg',
      instructions: [
    ...
    demoMediaPath: 'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?w=400&h=300&fit=crop',
    alternatives: ['pushup_regular', 'pushup_knee'],
    avoidWhen: []
  },
  {
    id: 'pushup_wall',
    ...
    difficulty: 'beginner',
    targetMuscles: ['chest', 'triceps'],
    tags: ['upper_body', 'push', 'standing', 'avoid_shoulders'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 15, defaultRest: '45s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/pushup-wall.svg',
      instructions: [
    ...
    demoMediaPath: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&h=300&fit=crop',
    alternatives: ['pushup_incline'],
    avoidWhen: []
  },
  ...
  // CORE
  {
    ...
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/crunch.svg',
      instructions: [
        'Lie on back, knees bent',
        'Phone on floor, side view',
  ...
  },
  {
    ...
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/plank-knee.svg',
      instructions: [
    ...
    demoMediaPath: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400&h=300&fit=crop',
    alternatives: ['plank'],
    avoidWhen: []
  },
  {
    ...
    difficulty: 'beginner',
    targetMuscles: ['abs', 'core'],
    tags: ['core', 'floor', 'avoid_back'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 10, defaultRest: '45s' },
    cameraSetup: {
      angle: 'front',
      silhouettePath: '/silhouettes/dead-bug.svg',
      instructions: [
  ...
  },
  {
    ...
    tags: ['core', 'balance', 'floor', 'avoid_back'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 10, defaultRest: '45s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/bird-dog.svg',
      instructions: [
        'Start on hands and knees',
        'Side view recommended',
    ...
    demoMediaPath: 'https://images.unsplash.com/photo-1599058917212-d750089bc07e?w=400&h=300&fit=crop',
  ...
  // CARDIO
  {
    ...
    cameraSetup: {
      angle: 'front',
      silhouettePath: '/silhouettes/jumping-jacks.svg',
      instructions: [
        'Stand facing camera',
        'Step back until full body visible',
        'Jump and spread arms/legs'
      ]
    },
    demoMediaPath: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400&h=300&fit=crop',
    alternatives: ['step_jacks', 'high_knees'],
    avoidWhen: []
  },
  {
    id: 'step_jacks',
    ...
    difficulty: 'beginner',
    targetMuscles: ['full_body'],
    tags: ['cardio', 'low_impact', 'avoid_knees'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 20, defaultRest: '45s' },
    cameraSetup: {
      angle: 'front',
      silhouettePath: '/silhouettes/step-jacks.svg',
      instructions: [
        'Front view',
  ...
  },
  {
    ...
    tags: ['cardio', 'full_body', 'floor'],
    prescription: { type: 'reps', defaultSets: 3, defaultReps: 20, defaultRest: '60s' },
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/mountain-climber.svg',
      instructions: [
  ...
  },
  {
    ...
    cameraSetup: {
      ...
      instructions: [
        'Stand facing camera',
        'Run in place, bring knees high',
        'Count total knee lifts'
      ]
    },
    demoMediaPath: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&h=300&fit=crop',
    alternatives: ['step_jacks', 'marching'],
    avoidWhen: []
  },
  ...
  // MOBILITY/WARMUP
  {
    ...
    tags: ['warmup', 'mobility', 'standing'],
    prescription: { type: 'reps', defaultSets: 1, defaultReps: 10, defaultRest: '0s' },
    cameraSetup: {
      angle: 'front',
      silhouettePath: '/silhouettes/arm-circles.svg',
      instructions: [
        'Stand facing camera',
    ...
    demoMediaPath: 'https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=400&h=300&fit=crop',
    alternatives: [],
    avoidWhen: ['avoid_shoulders']
  },
  {
    ...
    cameraSetup: {
      angle: 'side',
      silhouettePath: '/silhouettes/leg-swings.svg',
      instructions: [
        'Side view',
